...
class ThroughEffector : public BaseEffect {
public:
    ThroughEffector(IPluginProcessor& proc) : BaseEffect(proc,"Through",2,2)
    {
        setNumInputs(2);
        setNumOutputs(2);
